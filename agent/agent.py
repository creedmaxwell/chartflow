...
#     note_generator = create_note_generator_tool(model)

#     tools = [analyze_dental_chart, extract_chart_from_note, note_generator] 
...
# ... (keep your imports and AgentState class exactly the same) ...
